                ...
                <div class="col">
                    <form [formGroup]="form" (ngSubmit)="submit()">
                        ...
                        <div class="form-group">
                            ...
                            <div
                                *ngIf="
                                    getFormControl('planet').errors &&
                                    getFormControl('planet').touched
                                "
                                class="alert alert-danger mt-1"
                                role="alert"
                            >
                                <span
                                    *ngIf="
                                        getErrorControl('planet', 'required')
                                    "
                                >
                                    Campo obbligatorio
                                </span>
                                <span
                                    *ngIf="
                                        getErrorControl('planet', 'minlength')
                                    "
                                >
                                    Campo
                                    {{
                        ...
                        <div formArrayName="weakness" class="form-group">
                            ...
                            <div
                                *ngFor="
                                    let c of getFormArray('weakness');
                                    let i = index
                                "
                                class="form-group"
                            >
...
export class ReactiveFormComponent implements OnInit {
    ...
    addPower() {
        ...
        (this.form.get('powers') as UntypedFormArray).push(newControl);
    }

    getFormArray(name: string) {
        return (this.form.get(name) as UntypedFormArray).controls;
    }
    addWeakness() {
        const newControl = new UntypedFormControl(null);
        (this.form.get('weakness') as UntypedFormArray).push(newControl);
    }
