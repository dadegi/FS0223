...
if (totalShoppingCart < 50) {
	amountToPay += shippingCost; // amoutToPay = amountToPay + shippingCost
}
...
me.city = 'Toronto';
console.log(me);
document.getElementById('object').innerHTML = `${me.name}, ${me.lastName}, ${me.city}, my skills: ${me.skills[0]}, ${me.skills[1]}, ${me.skills[2]}`;
