...
let primocapo = new PrimoCapoAbbigliamento(1, 2121, 'primavera', 'cardigan', 1231, 5, 'nero', 18.50, 22.57, 'negozio', 45);
...
// set delle proprietà al costruttore
let secondocapo = new SecondoCapoAbbigliamento(1, 4111, 'estate', 't-shirt', 1251, 6, 'rosso', 5.50, 6.71, 'magazzino', 30); // stampo istanza secondocapo
...
// set delle proprietà al costruttore
let terzocapo = new TerzoCapoAbbigliamento(1, 1181, 'inverno', 'felpa', 1229, 8, 'beige', 17.50, 21.35, 'negozio', 50);
...
// set delle proprietà al costruttore
let quartocapo = new QuartoCapoAbbigliamento(1, 1111, 'estate', 'maglione', 1221, 4, 'verde', 20, 24.40, 'negozio', 50);
...
// set delle proprietà al costruttore
let quintocapo = new QuintoCapoAbbigliamento(1, 6111, 'primavera', 'maglia', 1021, 5, 'blue', 11, 13.42, 'magazzino', 60);
